...
def output_class_header(f, base_name, name, final=""):
    f.write("""
template<>
class vertex_inner<{name}> {final}: public vertex_inner<{base_name}> {{
public:""".format(name=name, base_name=base_name, final=final))
